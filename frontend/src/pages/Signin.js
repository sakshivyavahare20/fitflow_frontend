...
const Login = () => {
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
      <Container maxWidth="sm" sx={{ backgroundColor: "rgba(255, 255, 255, 0.9)", borderRadius: 2, padding: 4, boxShadow: "0px 4px 20px rgba(0, 0, 0, 0.2)" }}>
        <Typography variant="h4" component="h1" sx={{ fontWeight: "bold", mb: 2 }}>Login</Typography>
        ...
        <Typography variant="body2" sx={{ mt: 2 }}>
          ...
          <Link
            ...
            sx={{ cursor: "pointer", color: "#D32F2F", fontWeight: "bold", "&:hover": { textDecoration: "underline" } }}
          >
            Sign-Up
          </Link>
        </Typography>
