...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const confirmPasswordError = validateConfirmPassword(
      formData.confirm_password,  // Updated to 'confirm_password'
      formData.password
    );
    ...
    if (usernameError || emailError || passwordError || confirmPasswordError) {
      setErrors({
        ...
        confirm_password: confirmPasswordError,  // Updated to 'confirm_password'
      });
      return;
    }
    ...
    try {
      const response = await axios.post("http://127.0.0.1:8000/api/users/register/", {
        ...
        confirm_password: formData.confirm_password,  // Sending 'confirm_password'
      });
      ...
      if (err.response) {
        setErrors({
          ...
          confirm_password: err.response.data.confirmPassword || "",  // Updated to 'confirm_password'
        });
      }
    }
  };
